...
namespace SDCafeCommon.DataAccess
{
    public class DataAccessPOS1
    {
        ...
        public int Insert_TranCollection(POS1_TranCollectionModel pos1_TranCollectionModel)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Helper.CnnVal("POS1")))
            {
                string query = "INSERT INTO TranCollection (ReceiptNo,InvoiceNo,SplitId,TableId,TableName,NumOfPeople,Amount,Tax1,Tax2,Tax3," +
                                "TotalDue,CollectionType,IsOnline,Cash,Debit,Visa,Master,Amex,GiftCard,Online,CashTip," +
                                ...
                                "CreateStation,LastModDate,LastModTime,LastModPasswordCode,LastModPasswordName,LastModStation) " +
                                "VALUES (" +
                                ...
                                "CAST(@Visa as decimal(10,2)),CAST(@Master as decimal(10,2)),CAST(@Amex as decimal(10,2)),CAST(@Giftcard as decimal(10,2)),CAST(@Online as decimal(10,2)),"+
        ...
        public List<POS1_TranCollectionModel> Get_TranCollection_by_Date(string strStartDate, string strEndDate)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Helper.CnnVal("POS1")))
            {
