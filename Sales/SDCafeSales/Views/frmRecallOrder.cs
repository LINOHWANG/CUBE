...
{
    public partial class frmRecallOrder : Form
    {
        ...
        public frmRecallOrder(frmSalesMain _FrmSalesMain)
        {
            InitializeComponent();
        ...
        private void ClickNumberButton(object sender, EventArgs e)
        {
            ...
            {
                //this.Show();
                strInvoiceNo = txt_InvoiceNo.Text;
                bRecallNow = true;
                this.Close();
                return;
            }
            ...
            {
                strInvoiceNo = string.Empty;
                txt_InvoiceNo.Text = strInvoiceNo;
                bRecallNow = false;
                return;
            }
            if (btn.Text == "EXIT")  // OK
            ...
            txt_InvoiceNo.Text = strInvoiceNo + btn.Text;
            strInvoiceNo = txt_InvoiceNo.Text;
        }
    }
}
