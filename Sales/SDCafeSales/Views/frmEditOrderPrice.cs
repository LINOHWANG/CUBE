...
{
    public partial class frmEditOrderPrice : Form
    {
        ...
        public Color[] btColor =
{
        ...
        public frmEditOrderPrice(frmSalesMain _FrmSalesMain)
        {
            InitializeComponent();
        ...
        public void Set_Amount(double pAmount)
        {
            ...
            txt_OldAmount.Text = pAmount.ToString("C2");
        }
        ...
        private void ClickNumberButton(object sender, EventArgs e)
        {
            ...
            txt_NewPrice.Text = strNewPrice + btn.Text;
            //if ((txt_NewPrice.Text.Length > 2) && (txt_NewPrice.Text.IndexOf('.') < 0))
            if (txt_NewPrice.Text.Length > 2)
            {
                ...
                txt_NewPrice.Text = strTemp.Insert(strTemp.Length - 2, ".");
            }
            strNewPrice = txt_NewPrice.Text;
        }
    }
